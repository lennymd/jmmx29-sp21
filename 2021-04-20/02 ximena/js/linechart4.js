...
d3.csv('./data/data4.csv', function (data) {
  ...
  var allGroup = ['South Korea', 'East Asia & Pacific', 'China'];
  ...
  var x = d3.scaleLinear().domain([1975, 2015]).range([0, width]);
  ...
  svg.append('g').attr('class', 'y_axis').call(d3.axisLeft(y).ticks(4).tickSize(-width));

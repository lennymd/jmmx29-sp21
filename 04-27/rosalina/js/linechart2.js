function linechart2() {
  ...
  d3.csv('./data/linechart2.csv', function (data) {
    ...
    svg
      ...
      d3.selectAll('.linechart2_x_axis').selectAll('text')
      .attr('dy', '15px');
    ...
    d3.selectAll('.linechart2_y_axis').selectAll('text')
      .attr('dx', '-5px');
    // color palette
    var res = sumstat.map(function (d) {
      return d.key;
    }); // list of group names
    var color = d3.scaleOrdinal().domain(res).range(['#00557e', '#a25049']);
    ...
    // Add Chart Title and Subtitle 
      svg
      .append('text')
      .attr('class', 'linechart2_title_text')
      .attr('x', -30)
      .attr('y', 0 - (margin.top / 2))
      .text('Not Convicted vs. Convicted Population, 1983-2018')

      svg
      .append('text')
      .attr('class', 'linechart2_subtitle_text')
      .attr('x', -30)

function linechart2() {
  ...
  d3.csv('./data/linechart2.csv', function (data) {
    ...
    svg
      ...
      .attr('y', y(400000))
      .html(
        '<tspan dx="-20" dy="0">Pre-trial population grew</tspan><tspan dx="-150" dy="15">by 43% from 1998 to 2018</tspan>'
      )
    ...
    svg
      ...
      .attr('x', x(1999))
      .attr('y', y(230000))
      .text('Convicted population remained the same from 1998 to 2018')
      .attr('text-anchor', 'middle');

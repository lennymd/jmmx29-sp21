function groupedverticalbarchart_speeding() {
    ...
    var svg = d3.select("#groupedverticalbarchart_speeding")
        .append("svg")
    ...
    // Parse the Data
    d3.csv("./data/speeding.csv", function (data) {
        ...
        const xAxisText = xAxis
            .selectAll("text")
            .attr("class", "barchart_x_axis_text");
...
groupedverticalbarchart_speeding();